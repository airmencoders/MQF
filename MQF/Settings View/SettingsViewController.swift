...
class SettingsViewController: FormViewController {
    ...
    func setUpForm(){
        ...
        form
            ...
            +++ Section(header: "About", footer: "MQFs was #BuiltByAirmen for Airmen. We hope to make one small aspect of your life simpler and easier with this app. Please help us continue to improve this app by sending feedback to mqf@militarycoders.us.")
