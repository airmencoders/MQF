...
class MenuViewController: UIViewController {
    ...
    @IBAction func sendFeedback(_ sender: Any) {
        let alert = UIAlertController.init(title: "We'd love to hear from you!", message: "This app was built for aircrew by aircrew to make one small part of your life simpler and easier. Help us achieve that goal with your feedback. Please email it to mqf@militarycoders.us. Thanks!", preferredStyle: .alert)
